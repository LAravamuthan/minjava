 ...
 * of the heapfile.
 */
public class BufferScan implements GlobalConst {
  ...
  /** Current number of buffer frames */
  private int bLimit;

  /** Limit # of buffer frames */
  private int bSize;
   ...
   * @param bSize - # of frames to be used for a buffer
   */
  public BufferScan(Heapfile hf, int bSize)
   ...
   * @param hf A HeapFile object
   */
  private void init(Heapfile hf, int size)
          throws InvalidTupleSizeException,
          IOException {
    _hf = hf;
    bLimit = size;
