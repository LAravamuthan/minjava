...
class XMLDriver2 implements GlobalConst {
    ...
    public XMLDriver2(String fileName) {
        try {
...
//basically this function creates new heap files where each individual heap file contains only a particular tag value
    ...
    public NodeContext[] ExtractTagToHeap(NodeContext tag_params, String[] tagnames) throws IOException, HFException, HFBufMgrException, HFDiskMgrException {

        Heapfile heaptosearch = new Heapfile(tag_params.getNodeHeapFileName());
    ...
    public NodeContext[] ReadQueryAndExecute(NodeContext MainTagpair, String Queryfilename) throws HFDiskMgrException, HFException, HFBufMgrException, IOException {
...
public class XMLTestB// implements  GlobalConst
{
    public static void main(String[] argvs) {
        ...
        try {
            XMLDriver2 xmldvr = new XMLDriver2(DataFileName);
