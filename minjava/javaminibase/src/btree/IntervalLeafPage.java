 ...
 */
public class IntervalLeafPage extends IntervalSortedPage {
     ...
     */
    public IntervalLeafPage(PageId pageno, int keyType)
            throws IOException,
     ...
     *@exception ConstructPageException BTLeafPage constructor error
     */
    public IntervalLeafPage(Page page, int keyType)
            throws IOException,
            ConstructPageException
    {
        super(page, keyType);
     ...
     *@exception ConstructPageException BTLeafPage constructor error
     */
    public IntervalLeafPage( int keyType)
            throws IOException,
            ConstructPageException
    {
        super(keyType);
     ...
     */
    boolean redistribute(IntervalLeafPage leafPage, IntervalIndexPage parentIndexPage,
