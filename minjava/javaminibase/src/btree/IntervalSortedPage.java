 ...
 */
public class IntervalSortedPage  extends HFPage{
     ...
     */
    public IntervalSortedPage(PageId pageno, int keyType)
     ...
     *               AttrType.attrString or AttrType.attrInteger.
     */
    public IntervalSortedPage(Page page, int keyType) {
     ...
     *@exception  ConstructPageException error for BTSortedPage constructor
     */
    public IntervalSortedPage(int keyType)
            throws ConstructPageException
    {
        super();
        try{
