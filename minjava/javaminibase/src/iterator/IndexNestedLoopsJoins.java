...
public class IndexNestedLoopsJoins  extends Iterator
{
     ...
     *@param relationfile  the heapfile for the left hand side table.
 ...
 //                   outer_tuple.print(_in1);
         ...
         //       System.out.println("page no : " + rid.pageNo + " slot no: " + rid.slotNo);
                ...
                int innerS = innerinterval.getS();
                int innerE = innerinterval.getE();
                int outerS = outerinterval.getS();
                int outerE = outerinterval.getE();
