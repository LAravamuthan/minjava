...
public class IntervalTLeafPage extends IntervalTSortedPage {
   ...
   */
  public IntervalTLeafPage(PageId pageno, int keyType) 
    throws IOException, 
   ...
   *@exception ConstructPageException BTLeafPage constructor error
   */
  public IntervalTLeafPage(Page page, int keyType) 
    throws IOException, 
	   ConstructPageException
    {
      super(page, keyType);
   ...
   *@exception ConstructPageException BTLeafPage constructor error
   */
  public IntervalTLeafPage( int keyType) 
    throws IOException, 
	   ConstructPageException
    {
      super(keyType);
   ...
   */
  boolean redistribute(IntervalTLeafPage leafPage, IntervalTIndexPage parentIndexPage, 
